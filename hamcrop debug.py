...
class main():
    def __init__(self, name = None):
        ...
        self.folder  = None # Folder the file is in
        ...
        self.offset  = (0,100) # Does nothing anymore, used to add a margin
    ...
    def draw_rect(self,event):
        ...
        try:
            ...
            print("Draw_rect Attribute Error, this will fail if someone clicks the background befor img is loaded", e)
            return None
    ...
    def rot_90(self, event=''):
        ...
        try:
            ...
            print("Rot_90 Attribute Error, probably caused by clicking the button without an image loaded", e)
            return None
...
if __name__ == "__main__":
    try:
        #print(sys.argv[1])
        #app = main(sys.argv[1])
        app = main(r"D:\Users\Michael\OneDrive\Pictures\bark to the future.png")
    except:
